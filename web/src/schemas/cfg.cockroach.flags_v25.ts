// GENERATED from schemapb schema cfg.cockroach.flags@25 — do not edit.
// CockroachDB 25.x node start flags and cluster settings.

/** root */
export interface CfgCockroachFlags25 {
