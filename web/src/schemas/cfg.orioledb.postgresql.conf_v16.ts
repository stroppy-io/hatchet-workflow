// GENERATED from schemapb schema cfg.orioledb.postgresql.conf@16 — do not edit.
// postgresql.conf for the OrioleDB build of PostgreSQL 16: the stock 16 parameters plus the orioledb.* settings.

/** root */
export interface CfgOrioledbPostgresqlConf16 {
