// GENERATED from schemapb schema cfg.postgresql.conf@15 — do not edit.
// postgresql.conf for PostgreSQL 15 — every parameter verified against the 15 docs.

/** root */
export interface CfgPostgresqlConf15 {
