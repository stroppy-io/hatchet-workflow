// GENERATED from schemapb schema cfg.postgresql.conf@16 — do not edit.
// postgresql.conf for PostgreSQL 16 — every parameter verified against the 16 docs.

/** root */
export interface CfgPostgresqlConf16 {
