// GENERATED from schemapb schema cfg.my.cnf@8.4 — do not edit.
// MySQL 8.4 server configuration rendered to /etc/mysql/my.cnf ([mysqld] section).

/** root */
export interface CfgMyCnf8_4 {
  ...
  /** I/O capacity. Background page-flush budget in IOPS. Upstream default 10000 for 8.4. [IOPS] */
  ...
  /** Authentication policy. Factor list for CREATE USER; '*,,' means factor 1 uses default_authentication_plugin's successor (caching_sha2_password) and factors 2/3 are unused. Replaces default_authentication_plugin. */
  authentication_policy?: string;
  /** mysql_native_password. The deprecated native plugin is off by default in 8.4; ON only for legacy clients. */
  mysql_native_password?: "ON" | "OFF";
