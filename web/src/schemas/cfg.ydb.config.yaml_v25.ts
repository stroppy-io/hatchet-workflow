// GENERATED from schemapb schema cfg.ydb.config.yaml@25 — do not edit.
// YDB 25.x static cluster configuration (config.yaml, configuration V1).

/** object  */
export interface CfgYdbConfigYaml25Item {
...
/** object  */
export interface CfgYdbConfigYaml25Item2 {
...
/** object  */
export interface CfgYdbConfigYaml25Item3 {
...
export interface CfgYdbConfigYaml25 {
  ...
  hosts?: Array<CfgYdbConfigYaml25Item2>;
  ...
  storage_pool_types?: Array<CfgYdbConfigYaml25Item3>;
