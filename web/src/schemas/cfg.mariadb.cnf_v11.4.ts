// GENERATED from schemapb schema cfg.mariadb.cnf@11.4 — do not edit.
// MariaDB 11.4 server configuration rendered to /etc/mysql/mariadb.conf.d/50-server.cnf ([mariadb] section).

/** root */
export interface CfgMariadbCnf11_4 {
