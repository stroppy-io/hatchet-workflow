// GENERATED from schemapb schema cfg.postgresql.conf@17 — do not edit.
// postgresql.conf for PostgreSQL 17 — every parameter verified against the 17 docs.

/** root */
export interface CfgPostgresqlConf17 {
