// GENERATED from schemapb schema cfg.postgresql.conf@18 — do not edit.
// postgresql.conf for PostgreSQL 18 — every parameter verified against the 18 docs.

/** root */
export interface CfgPostgresqlConf18 {
