...
export interface DbYdbManagedParams1 {
  ...
  /** Throttling RCU limit. serverless_database.throttling_rcu_limit — provisioned RU/s billed hourly; 0 disables hourly billing. [RU/s] */
  throttling_rcu_limit?: number | string;
  /** Provisioned RCU limit. serverless_database.provisioned_rcu_limit — the ceiling on consumed RU/s; 0 = no limit. [RU/s] */
