...
import { getRunMetrics } from "@/services/client";
...
const metricCategories: Record<string, string[]> = {
  "Database": ["db_qps", "db_tps", "db_latency_p99", "db_connections", "db_repl_lag", "db_errors", "db_sessions", "db_tablets", "db_raft_commit", "db_tables", "db_cpu", "db_storage"],
