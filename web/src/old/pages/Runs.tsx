...
import { listRuns, deleteRun, cancelRun, getRunStatus, listPresets, getSuite, listSuites } from "@/services/client";
import type { RunSummary, RunConfig } from "@/services/types";
import {
  Table,
  TableBody,
  TableCell,
