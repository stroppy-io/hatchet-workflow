...
import { ALL_DB_KINDS, type Preset, type DatabaseKind } from "@/services/types";
...
function extractFeatures(preset: Preset): string[] {
  ...
  if (preset.db_kind === "postgres") {
    const pg = t as import("@/services/types").PostgresTopology;
    ...
    const my = t as import("@/services/types").MySQLTopology;
    ...
    const pico = t as import("@/services/types").PicodataTopology;
    ...
    const ydb = t as import("@/services/types").YDBTopology;
