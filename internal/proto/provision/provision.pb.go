...
const file_provision_provision_proto_rawDesc = "" +
	...
	"\rBackupRuntime\x12C\n" +
	"\x06config\x18\x01 \x01(\v2!.database.Postgres.Sidecar.BackupB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06config\x1a\\\n" +
...
var file_provision_provision_proto_goTypes = []any{
	...
	(*database.Postgres_Addons_Pooling_Pgbouncer)(nil), // 27: database.Postgres.Addons.Pooling.Pgbouncer
	(*database.Postgres_Sidecar_Backup)(nil),           // 28: database.Postgres.Sidecar.Backup
...
var file_provision_provision_proto_depIdxs = []int32{
	...
	27, // 23: provision.Container.PgbouncerRuntime.config:type_name -> database.Postgres.Addons.Pooling.Pgbouncer
	28, // 24: provision.Container.BackupRuntime.config:type_name -> database.Postgres.Sidecar.Backup
