...
const (
	PackageService_CreatePackage_FullMethodName = "/cloud.v1.catalog.PackageService/CreatePackage"
	PackageService_UpdatePackage_FullMethodName = "/cloud.v1.catalog.PackageService/UpdatePackage"
	PackageService_DeletePackage_FullMethodName = "/cloud.v1.catalog.PackageService/DeletePackage"
	PackageService_GetPackage_FullMethodName    = "/cloud.v1.catalog.PackageService/GetPackage"
	PackageService_ListPackages_FullMethodName  = "/cloud.v1.catalog.PackageService/ListPackages"
	PackageService_ClonePackage_FullMethodName  = "/cloud.v1.catalog.PackageService/ClonePackage"
)
...
type PackageServiceClient interface {
	...
	DeletePackage(ctx context.Context, in *PackageId, opts ...grpc.CallOption) (*Package, error)
	GetPackage(ctx context.Context, in *PackageId, opts ...grpc.CallOption) (*Package, error)
	ListPackages(ctx context.Context, in *ListPackagesRequest, opts ...grpc.CallOption) (*Package_List, error)
	ClonePackage(ctx context.Context, in *PackageId, opts ...grpc.CallOption) (*Package, error)
}
...
func (c *packageServiceClient) CreatePackage(ctx context.Context, in *CreatePackageRequest, opts ...grpc.CallOption) (*Package, error) {
...
func (c *packageServiceClient) UpdatePackage(ctx context.Context, in *UpdatePackageRequest, opts ...grpc.CallOption) (*Package, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Package)
...
func (c *packageServiceClient) DeletePackage(ctx context.Context, in *PackageId, opts ...grpc.CallOption) (*Package, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Package)
...
func (c *packageServiceClient) ListPackages(ctx context.Context, in *ListPackagesRequest, opts ...grpc.CallOption) (*Package_List, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Package_List)
...
func (c *packageServiceClient) ClonePackage(ctx context.Context, in *PackageId, opts ...grpc.CallOption) (*Package, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Package)
	err := c.cc.Invoke(ctx, PackageService_ClonePackage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PackageServiceServer interface {
	...
	DeletePackage(context.Context, *PackageId) (*Package, error)
	GetPackage(context.Context, *PackageId) (*Package, error)
	ListPackages(context.Context, *ListPackagesRequest) (*Package_List, error)
	ClonePackage(context.Context, *PackageId) (*Package, error)
...
func (UnimplementedPackageServiceServer) CreatePackage(context.Context, *CreatePackageRequest) (*Package, error) {
	return nil, status.Error(codes.Unimplemented, "method CreatePackage not implemented")
}
func (UnimplementedPackageServiceServer) UpdatePackage(context.Context, *UpdatePackageRequest) (*Package, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdatePackage not implemented")
}
func (UnimplementedPackageServiceServer) DeletePackage(context.Context, *PackageId) (*Package, error) {
...
func (UnimplementedPackageServiceServer) ListPackages(context.Context, *ListPackagesRequest) (*Package_List, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPackages not implemented")
}
func (UnimplementedPackageServiceServer) ClonePackage(context.Context, *PackageId) (*Package, error) {
	return nil, status.Error(codes.Unimplemented, "method ClonePackage not implemented")
}
...
func _PackageService_ClonePackage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PackageId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PackageServiceServer).ClonePackage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PackageService_ClonePackage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PackageServiceServer).ClonePackage(ctx, req.(*PackageId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PackageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.v1.catalog.PackageService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ClonePackage",
			Handler:    _PackageService_ClonePackage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cloud/v1/catalog/package.proto",
}
