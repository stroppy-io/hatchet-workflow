...
const (
	WebhookService_CreateWebhook_FullMethodName = "/cloud.v1.api.ui.WebhookService/CreateWebhook"
	WebhookService_ListWebhooks_FullMethodName  = "/cloud.v1.api.ui.WebhookService/ListWebhooks"
	WebhookService_UpdateWebhook_FullMethodName = "/cloud.v1.api.ui.WebhookService/UpdateWebhook"
	WebhookService_DeleteWebhook_FullMethodName = "/cloud.v1.api.ui.WebhookService/DeleteWebhook"
	WebhookService_TestWebhook_FullMethodName   = "/cloud.v1.api.ui.WebhookService/TestWebhook"
)
...
func (c *webhookServiceClient) CreateWebhook(ctx context.Context, in *CreateWebhookRequest, opts ...grpc.CallOption) (*models.Webhook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(models.Webhook)
...
func (c *webhookServiceClient) UpdateWebhook(ctx context.Context, in *UpdateWebhookRequest, opts ...grpc.CallOption) (*models.Webhook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(models.Webhook)
...
func (c *webhookServiceClient) TestWebhook(ctx context.Context, in *TestWebhookRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedWebhookServiceServer) TestWebhook(context.Context, *TestWebhookRequest) (*emptypb.Empty, error) {
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cloud.v1.api.ui.WebhookService",
	...
	Metadata: "cloud/v1/api/ui/webhook.proto",
}
