		...
		case '/': // Prefix: "/api/v1/"
			...
			case 'r': // Prefix: "r"
				...
				case 'e': // Prefix: "ecipe/"
					...
					case 'd': // Prefix: "delete-recipe"

						if l := len("delete-recipe"); len(elem) >= l && elem[0:l] == "delete-recipe" {
							elem = elem[l:]
						} else {
							break
						}
					...
					case 'l': // Prefix: "list-recipes"

						if l := len("list-recipes"); len(elem) >= l && elem[0:l] == "list-recipes" {
							elem = elem[l:]
						} else {
							break
						}
