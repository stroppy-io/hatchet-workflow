...
const file_cloud_v1_models_testing_proto_rawDesc = "" +
	...
	"\x03dag\x18\x06 \x01(\v2\x16.cloud.v1.models.DagIdB\x1a\xfaB\x05\x8a\x01\x02\x10\x01\x9a\xb5\x18\x0e\x12\f2\x04dags:\x02id@\x01R\x03dag\x12H\n" +
	"\ttest_runs\x18\b \x03(\v2\x18.cloud.v1.models.TestRunB\x11\xa2\xb5\x18\r\n" +
	"\v\n" +
	"\auser_id\x18\x01R\btestRuns\x1a?\n" +
	"\x04List\x127\n" +
