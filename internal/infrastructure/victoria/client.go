// Package victoria holds thin net/http clients for the VictoriaMetrics
// (Prometheus-compatible) and VictoriaLogs (LogsQL) read APIs. They speak the
// plain HTTP wire shapes; no third-party client libraries are pulled in.
package victoria
...
// NewClient creates a VictoriaMetrics client. baseURL is the Prometheus-API root
// (e.g. http://victoria-metrics:8428 or <base>/select/0/prometheus for a
// multi-tenant gateway). token may be empty to disable bearer auth.
