...
type YDBStaticConfig struct {
	...
	HostLocations     []string          `json:"host_locations,omitempty"`
	...
	DefaultDiskType   string            `json:"default_disk_type,omitempty"`
...
type YDBInitConfig struct {
	...
	StoragePoolKind string `json:"storage_pool_kind,omitempty"`
}
