...
//	managers2 "github.com/stroppy-io/hatchet-workflow/internal/domain/managers"
...
//		}),
//	})
//	networkManager, err := managers2.NewNetworkManager(valkeyClient, managers2.DefaultNetworkConfig())
//	if err != nil {
//		return nil, fmt.Errorf("failed to create network manager: %w", err)
//	}
//	quotaManager, err := managers2.NewQuotaManager(valkeyClient, managers2.DefaultQuotasConfig())
//	if err != nil {
...
//					ConnectionString: installers.DefaultConfig().PostgresUrlByIp(waitOutput.GetNetwork().GetIps()[0].GetValue()),
