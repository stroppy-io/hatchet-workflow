module github.com/stroppy-io/stroppy-cloud/pipelines
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/servicequotas v1.42.0
...
require (
	...
	github.com/crossplane/upjet/v2 v2.4.0 // indirect
